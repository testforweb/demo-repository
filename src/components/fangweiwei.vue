<template>
	<div>
		<canvas width="500" height="500" id="canvasf"></canvas>
	</div>
</template>
	...
	data() {
		return {
			...
			options: {
				...
				yAxisLabel: ['0', '1000000000', '2000000000', '3000000000', '4000000000'], //标示Y轴坐标
				yMax: 4000000000, //Y轴最大值
				xAxisLabel: ['案例总数', '死亡人数', '疫苗总给予量', '疫苗接种量'], //X轴坐标
				// 由于数据之间相差太大，修改至相同数量级，data[1]源数据：6,852,711
				data: [672581763, 685271121, 3489514000, 1276517000], //柱状图数据
				barStyle: {
					width: 50, //柱状图宽度
					color: '#1abc9c', //柱状图颜色
				},
