void function(global){
	...
	//加载模块，如果模块已经被加载，从缓存返回该模块，否则加载模块并缓存
...
define("scripts/sence.js", function(exports){
	...
	// initialize sence
	exports.init = function(){
	    menuSnd = sound.create( "sound/msenu" );
	    gameStartSnd = sound.create( "sousnd/start" );
		[ background,  logo, ninja, dojo, newGame, quit, score, lose, developing, gameOver, flash /*, fps */ ].invoke( "set" );
	};
	...
	exports.hideMenu = function( callback ){
	    [dojo, newGame, quit ].invoke( "hide" );
	    [ logo, ninja].invoke( "hide" );
...
define("scripts/factory/fruit.js", function(exports){
	...
	var infos = {
		...
		boom: [ "images1/virus/bai.png", 66, 68, 26, 0, 0, null ],
		boom1: [ "images1/virus/tunshi.png", 66, 68, 26, 0, 0, null ],
		boom2: [ "images1/virus/T.png", 66, 68, 26, 0, 0, null ],
		peach: [ "../images1/virus/peach.png", 100, 100, 37, -50, 0, "#00ffff" ],
		sandia: [ "../images1/virus/sandia.png", 150, 100, 38, -100, 0, "#37ff0b" ],
		apple: [ "images1/virus/apple.png", 66, 66, 31, -54, 0, "#c8e925" ],
		banana: [ "images1/virus/banana.png", 128, 120, 43, 90, 0, "#ffff00" ],
		basaha: [ "images1/virus/basaha.png", 100, 80, 32, -135, 0, "#aa00ff" ]
	};
	...
	function ClassFruit(conf){
	    ...
	    if( this.type === "boom" || this.type === "boom1" || this.type === "boom2" )
	...
	ClassFruit.prototype.hide = function( start ){
		if( this.type !== "boom" || this.type !== "boom1" || this.type !== "boom2" ) // if it is not a boom, it can't to be hide.
		    return ;
...
define("scripts/object/developing.js", function(exports){
	...
	exports.set = function(){
		this.image = layer.createImage( "default", "images1/background1.png", 0, 0, 640, 480 ).hide().scale( 1e-5, 1e-5 );
	};
	exports.show = function( start ){
	    timeline.createTask({
			start: start, duration: 5000, data: [ 1e-5, 1, "show" ],
...
define("scripts/object/dojo.js", function(exports){
	...
	exports = displacement.create("images1/jianjie.png", 280, 135, 17, -182, 17, 180, tween.exponential.co, 1e3);;
	return exports;
});
...
define("scripts/object/flame.js", function(exports){
	...
	exports.create = function( ox, oy, start ){
		...
		var nx = ox, ny = oy;
		var image = layer.image("images1/smoke.png", nx - 21, ny - 21, 43, 43).hide();
		var flames = {};
...
define("scripts/object/flash.js", function(exports){
	...
	exports.set = function(){
		image = layer.createImage( "flash", "images1/flash.png", 0, 0, 358, 20 ).hide();
...
define("scripts/object/game-over.js", function(exports){
	...
	exports.set = function(){
		this.image = layer.createImage( "default", "images1/game-over.png", 75, 198, 490, 85 ).hide().scale( 1e-5, 1e-5 );
	};
...
define("scripts/object/logo.js", function(exports){
	...
	exports = displacement.create("images1/logo1.png", 288, 135, 17, -182, 17, 1, tween.exponential.co, 1e3);;
...
define("scripts/object/lose.js", function(exports){
	...
	var conf1 = { src: "images1/x.png", sx: 650, ex: 561, y: 5, w: 22, h: 19 };
	var conf2 = { src: "images1/xx.png", sx: 671, ex: 582, y: 5, w: 27, h: 26 };
	var conf3 = { src: "images1/xxx.png", sx: 697, ex: 608, y: 6, w: 31, h: 32 };
	...
	function createPosShow( x ){
	    var image = layer.createImage( "default", "images1/lose.png", x - 27, 406, 54, 50 ).scale( 1e-5, 1e-5 );
	    var duration = 500;
...
define("scripts/object/new-game.js", function(exports){
	...
	var tween = require("scripts/lib/tween");
	var displacement = require("scripts/factory/displacement");
	exports = displacement.create("images1/kaishi.png", 280, 135, 220, -182, 220, 180, tween.exponential.co, 1e3);;
	
	//exports = rotate.create("images/news-game.png", 244, 231, 195, 195, 1e-5, tween.exponential.co, 500);;
...
define("scripts/object/ninja.js", function(exports){
	...
	exports = displacement.create("images1/ninja1.png", 244, 81, 315, -140, 315, 43, {
...
define("scripts/object/quit.js", function(exports){
	...
	var displacement = require("scripts/factory/displacement");
	exports = displacement.create("images1/xiayibu.png", 280, 135, 420, -182, 420, 240, tween.exponential.co, 1e3);;
...
define("scripts/object/score.js", function(exports){
	...
	exports.set = function(){
	    image = layer.createImage( "default", "images1/score.png", imageSx, 8, 29, 31 ).hide();
